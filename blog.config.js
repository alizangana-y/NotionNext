...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alizangana', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '玉楼金阙慵归去，且插梅花醉洛阳。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-two-jade.vercel.app/', // 网站地址
